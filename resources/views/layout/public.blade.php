        ...
        <section class="headerPrincipal">
            ...
            <div class="container-slider">
                ...
                <figure class="slider" id="slider">
                    ...
                    <section class="slider-section">
                        <img class="img" src="{{url('images/slides/poster_2.jpg')}}" alt="">
                    </section>
                    <section class="slider-section">
                        <img class="img" src="{{url('images/slides/poster_3.jpg')}}" alt="">
                    </section>
                    <section class="slider-section">
                        <img class="img" src="{{url('images/slides/poster_4.jpg')}}" alt="">
                    </section>
                </figure>
            </div>  
        </section> 
