...
@section('contenido')
    ...
    <main class="form-crear-evento">
        <div class="contenedor contenido-formulario">
            ...
            <form action="{{ route('eventos.update', $eventosi->id_evento )}}" method="post" class="formulario" enctype="multipart/form-data">
			@csrf
            @method('PATCH')
                ...
                <fieldset class="form-grupo">
                    <div class="form-grupoContainer">
                        ...
                        <div class="campo">
							...
							<input class="set__data" type="text" id="id_promotor" name="id_promotor" placeholder="Cedula creador del evento"
                                @foreach ($users as $user) 
                                    value="{{ old('telefono') ??  $user->cedula }}"
                                @endforeach
                                required >
						</div>
                        ...
                        <div class="campo">
							...
							<input class="set__data" type="text" id="nombre_evento" name="nombre_evento" {{$errors->has('nombre_evento') ? 'is-invalid' : ''}}" value="{{ old('nombre_evento') ??  $eventosi->nombre_evento }}" required> 
							@error('nombre_evento')
						...
						<div class="campo">
							...
							<select class="set__data" id="id_categoria_ev" name="id_categoria_ev"  {{$errors->has('id_categoria_ev') ? 'is-invalid' : ''}}" value="{{ old('id_categoria_ev') ??  $eventosi->id_categoria_ev }}" required>
								<option value="Musical">Musica</option>
								<option value="Teatro">Teatro</option>
								<option value="Deporte">Deportes</option>
								<option value="{{ old('id_categoria_ev') ??  $eventosi->id_categoria_ev }}" selected>{{ old('id_categoria_ev') ??  $eventosi->id_categoria_ev }}</option>
							</select>
						...
						<div class="campo campo--infoBasica">
							...
							<textarea class="set__data" id="descripcion" name="descripcion" {{$errors->has('descripcion') ? 'is-invalid' : ''}}" required>{{ old('descripcion') ??  $eventosi->descripcion }}</textarea>                     
							@error('descripcion')
							<div style="background: #E57373; color: white;">{{ $message }}</div>
							@enderror
						</div>
                ...
                <fieldset class="form-grupo">
                    <div class="form-grupoContainer form-grupoContainer--ubicacion">
                        ...
                        <div class="campo">
                            ...
                            <input class="login-campo-texto" type="text" id="ciudad" name="ciudad" {{$errors->has('ciudad') ? 'is-invalid' : ''}}" value="{{ old('Ciudad') ??  $eventosi->Ciudad }}" required> 
                            @error('ciudad')
                                <div style="background: #E57373; color: white;">{{ $message }}</div>
                            @enderror
                        </div>
						...
						<div class="campo">
							...
							<input type="text" id="direccion" name="direccion" {{$errors->has('direccion') ? 'is-invalid' : ''}}" value="{{ old('direccion') ??  $eventosi->direccion }}"> 
							@error('direccion')
								<div style="background: #E57373; color: white;">{{ $message }}</div>
							@enderror
						</div>
                        ...
                        <div class="campo">
							...
							<input type="text" id="Nombre_sitio" name="Nombre_sitio" {{$errors->has('Nombre_sitio') ? 'is-invalid' : ''}}" value="{{ old('Nombre_sitio') ??  $eventosi->Nombre_sitio }}" placeholder="Centro de eventos Tick" required> 
							@error('Nombre_sitio')
								<div style="background: #E57373; color: white;">{{ $message }}</div>
							@enderror
						</div>
                        ...
                        <div class="campo">
                            ...
                            <input id="latitud" name="latitud" type="text" {{$errors->has('latitud') ? 'is-invalid' : ''}}" value="{{ old('latitud') ??  $eventosi->latitud }}" required>
                            @error('latitud')
                                <div style="background: #E57373; color: white;">{{ $message }}</div>
                            @enderror 
                            <label for="longitude">Longitude:</label>
                            <input id="longitud" name="longitud" type="text" {{$errors->has('longitud') ? 'is-invalid' : ''}}" value="{{ old('longitud') ??  $eventosi->longitud }}" required>
                            @error('longitud')
                                <div style="background: #E57373; color: white;">{{ $message }}</div>
                            @enderror 
                        </div>
                ...
                <fieldset class="form-grupo">
                    <div class="form-grupoContainer form-grupoContainer--asistir">
						...
						<div class="campo">
							...
							<input type="date" id="fecha_incio" name="fecha_incio" {{$errors->has('fecha_incio') ? 'is-invalid' : ''}}" value="{{ old('fecha_incio') ??  $eventosi->fecha_incio }}"  required> 
							@error('fecha_incio')
								<div style="background: #E57373; color: white;">{{ $message }}</div>
							@enderror                    
						</div>
						...
						<div class="campo">
							...
							<input type="time" id="hora_inicio" name="hora_inicio" {{$errors->has('hora_inicio') ? 'is-invalid' : ''}}" value="{{ old('hora_inicio') ??  $eventosi->hora_inicio }}" required> 
							@error('hora_inicio')
								<div style="background: #E57373; color: white;">{{ $message }}</div>
							@enderror                    
						</div>
                ...
                <fieldset class="form-grupo">
                    <div class="form-grupoContainer">
						...
						<div class="campo">
							...
							<select id="modalidad" name="modalidad"  {{$errors->has('modalidad') ? 'is-invalid' : ''}}" value="{{ old('modalidad') ??  $eventosi->modalidad }}" required>
								<option value="Presencial">Presencial</option>
								<option value="Virtual">Virtual</option>
								<option value="{{ old('modalidad') ??  $eventosi->modalidad }}" selected>{{ old('modalidad') ??  $eventosi->modalidad }}</option>
							</select>
							@error('modalidad')
								<div style="background: #E57373; color: white;">{{ $message }}</div>
							 @enderror
						...
						<div class="campo">
							...
							<select id="medio_transmision" name="medio_transmision" {{$errors->has('medio_transmision') ? 'is-invalid' : ''}}" value="{{ old('medio_transmision') ??  $eventosi->medio_transmision }}" required>
								<option value="Ninguno">Ninguno</option>
								<option value="Youtube">Youtube</option>
								<option value="Twich">Twich</option>
								<option value="Facebook">Facebook</option>
								<option value="{{ old('medio_transmision') ??  $eventosi->medio_transmision }}" selected>{{ old('medio_transmision') ??  $eventosi->medio_transmision }}</option>
							</select>
						...
						<div class="campo">
							...
							<input type="text" id="enlace_conexion" name="enlace_conexion" {{$errors->has('enlace_conexion') ? 'is-invalid' : ''}}" value="{{ old('enlace_conexio') ??  $eventosi->enlace_conexio }}" required> 
                ...
                <fieldset class="form-grupo">
                    <div class="form-grupoContainer">
                        <div class="campo">
                            ...
                            <textarea id="anfitriones" name="anfitriones"{{$errors->has('anfitriones') ? 'is-invalid' : ''}} required>{{ old('anfitriones') ??  $eventosi->anfitriones }}</textarea>
                            @error('anfitriones')
                            <div style="background: #E57373; color: white;">{{ $message }}</div>
                            @enderror   
                        </div>                       
                ...
                <fieldset class="form-grupo">
                    <div class="form-grupoContainer form-grupoContainer--costos">
                        <div class="campo">
                            ...
                            <select id="monetizacion" name="monetizacion" {{$errors->has('monetizacion') ? 'is-invalid' : ''}}" value="{{ old('monetizaion') ??  $eventosi->monetizacion }}" required>
						...
						<div class="campo">
							...
							<input type="text" id="aforo" name="aforo" {{$errors->has('aforo') ? 'is-invalid' : ''}}" value="{{ old('aforo') ??  $eventosi->aforo }}" required> 
							@error('aforo')
								<div style="background: #E57373; color: white;">{{ $message }}</div>
							@enderror                    
						</div>
                        ...
                        <div class="campo">
                            ...
                            <input type="number" value="{{ old('aforo') ??  $eventosi->aforo }}" >
                        </div>
						
						<div class="campo">
							<label for="costoboleta">Costo boleta:</label>
							<input type="text" id="costoboleta" name="costoboleta" {{$errors->has('costoboleta') ? 'is-invalid' : ''}}" value="{{ old('costoboleta') ??  $eventosi->costoboleta }}" required> 
							@error('costoboleta')
								<div style="background: #E57373; color: white;">{{ $message }}</div>
							@enderror                    
						</div>
