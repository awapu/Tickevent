...
@section('contenido')
    ...
    <main class="form-crear-evento">
      <div class="contenedor contenido-formulario">
          <form class="formulario formulario-registro" action="{{route('servicios.update', $serviciosi->id )}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
              ...
              <fieldset class="form-grupo">
                  <div class="form-grupoContainer">
                    ...
                    <div class="campo">
                        <label class="descripcionServicio" for="descripcion">Nombre promotor:</label>
                    ...
                    <div class="campo">
                        ...
                        @foreach ($users as $user) 
                         value="{{ $user->email}}"
                        @endforeach
                        {{$errors->has('correo') ? 'is-invalid' : ''}}" value="{{ old('correo') }}"> 
							@error('correo')
                    ...
                    <div class="campo">
                      ...
                      <div class="campo">
                          ...
                          <textarea class="set__data" id="descripcion" name="descripcion" {{$errors->has('descripcion') ? 'is-invalid' : ''}} required>{{$serviciosi->descripcion}}"</textarea>    
              ...
              <fieldset class="form-grupo form-grupo--lastFieldset">
                  ...
                  <div class="campo">
                      ...
                      <div class="campo__imgContainer">
                          <img id="campo__img0102" class="campo__img" src="{{asset('storage').'/'.$serviciosi->imagen}}" alt="" >
                      </div>
